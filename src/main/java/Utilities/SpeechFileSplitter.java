...
/*
  Ken Kousen's  file chunker

  I need to remove any references to a file.  I only want strings, not a transcription stored in a file. -fdg
 */
...
public class SpeechFileSplitter {
    ...
    public List<File> splitWavFileIntoChunks(File sourceWavFile) {
        ...
        try (var inputStream = AudioSystem.getAudioInputStream(sourceWavFile)) {
            ...
            long framesPerChunk = SpeechTranscribe.MAX_CHUNK_SIZE_BYTES / frameSize;
