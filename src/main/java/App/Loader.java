...
public class Loader {
    ...
    public static void main(String[] args) throws VectorDBException, LLMCompletionException, IOException {
        ...
        ps.loadwebsite("https://www.deepnetts.com", 3);
        ...
        ps.loadurl("https://www.infoq.com/articles/java-machine-learning-djl");
        ...
        ps.loadurl("https://blogs.oracle.com/developers/post/introduction-to-machine-learning-and-neural-networks-for-java-developers");
        ...
        ps.loadrecording("/Users/fgreco/src/Finetuning/src/main/resources/zoran-foojayio.mp3");
    }
}
